...
export function NavigationRailDesktop({ currentView, onNavigateToView }: NavigationRailDesktopProps) {
  ...
  return (
    <TooltipProvider delayDuration={120}>
      <nav
        aria-label="Primary"
        className={`flex h-full flex-col bg-background/40 backdrop-blur-2xl p-3 transition-[width] duration-300 ease-in-out z-10 shadow-[1px_0_10px_rgba(0,0,0,0.02)] max-md:hidden ${
