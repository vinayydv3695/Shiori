    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content 
          ...
          className="fixed inset-x-0 bottom-0 sm:top-1/2 sm:bottom-auto sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 w-full sm:w-[90vw] max-w-md bg-card/85 backdrop-blur-2xl border-t sm:border border-border/80 rounded-t-3xl sm:rounded-3xl shadow-2xl z-[210] flex flex-col p-5 sm:p-6 gap-4 max-h-[85vh] overflow-hidden focus:outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-bottom-full data-[state=open]:slide-in-from-bottom-full sm:data-[state=closed]:zoom-out-95 sm:data-[state=open]:zoom-in-95 duration-300 transform-gpu"
        >
          {/* Mobile Drag Handle */}
          <div className="w-10 h-1 rounded-full bg-muted-foreground/30 mx-auto mt-0 mb-1 sm:hidden shrink-0" />
