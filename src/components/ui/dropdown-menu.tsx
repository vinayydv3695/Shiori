...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[100] min-w-[8rem] overflow-hidden rounded-2xl border border-border bg-popover !bg-popover !opacity-100 p-1 text-popover-foreground shadow-2xl",
