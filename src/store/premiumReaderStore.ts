...
interface ReadingSettings {
  ...
  setAnimationStyle: (style: 'slide' | 'fade' | 'curl' | 'none') => void;
...
const ANIMATION_STYLE_OPTIONS: Array<ReadingSettings['animationStyle']> = ['slide', 'fade', 'curl', 'none'];
