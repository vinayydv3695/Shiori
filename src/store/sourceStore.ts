...
const DEFAULT_SOURCES: SourceConfig[] = [
  ...
  },
  {
    ...
    kind: 'manga',
    enabled: false,
    description: 'Webtoons and manhwa with high-quality scans.',
    status: 'active',
    implemented: true,
    torboxCompatible: false,
    capabilities: ['direct'],
  ...
  },
  {
    ...
    kind: 'manga',
    enabled: false,
    description: 'Popular webtoons and manhwa in high quality.',
    status: 'active',
    implemented: true,
    torboxCompatible: false,
    capabilities: ['direct'],
  ...
  },
  {
    ...
    kind: 'manga',
    enabled: false,
    description: 'Fast updates for manhwa and webtoons.',
    status: 'active',
    implemented: true,
    torboxCompatible: false,
    capabilities: ['direct'],
    website: 'https://toontop.io',
  },
  {
    id: 'manhwaread',
    name: 'ManhwaRead',
  ...
  },
  {
    ...
    kind: 'manga',
    enabled: false,
    description: 'Anime and manga torrent tracker for Torbox users.',
    status: 'active',
    implemented: true,
  ...
  },
  {
    ...
    kind: 'books',
    enabled: false,
    description: "Massive open library; requires a session cookie or Torbox for downloads. Enable if you use Anna's Archive.",
    status: 'active',
    implemented: true,
    torboxCompatible: true,
