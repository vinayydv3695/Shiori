...
const DEFAULT_SOURCES: SourceConfig[] = [
  {
    ...
    kind: 'manga',
    enabled: true,
    description: '✅ Most reliable - Official API with huge catalog and no restrictions.',
    status: 'active',
    implemented: true,
  ...
  },
  {
    ...
    kind: 'manga',
    enabled: true,
    description: 'Large catalog with good availability. May occasionally require retry.',
    status: 'active',
    implemented: true,
  },
  {
    ...
    kind: 'manga',
    enabled: true,
    description: 'Massive manga collection. Alternative domain helps avoid blocks.',
    status: 'active',
    implemented: true,
  },
  {
    ...
    kind: 'manga',
    enabled: false,
    description: 'Manhwa/Webtoons focus. May have regional restrictions.',
    status: 'active',
    implemented: true,
  },
  {
    ...
    kind: 'manga',
    enabled: true,
    description: 'Latest chapters for popular ongoing series. Limited catalog.',
    status: 'active',
    implemented: true,
  },
  {
    ...
    kind: 'manga',
    enabled: false,
    description: '⚠️ Heavy Cloudflare protection - use other sources for better reliability.',
    status: 'active',
    implemented: true,
  },
  {
  ...
  },
  {
    ...
    kind: 'books',
    enabled: true,
    description: 'Massive book collection with multiple download mirrors.',
    status: 'active',
    implemented: true,
