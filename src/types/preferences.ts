...
export type Theme = 'white' | 'black' | 'light' | 'dark' | 'system' | 'sepia' | 'gray' | 'high-contrast' | 'rose-pine-moon' | 'catppuccin-mocha' | 'hello-kitty' | 'midnight-pink' | 'nord' | 'dracula' | 'tokyo-night' | 'premium-dark';
